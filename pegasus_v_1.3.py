#!/usr/bin/env python3
# Pegasus v1.3 - Reconstruction/modifications: Sayed Eslamuddin
...
"""
HEADER_LINES = [
    " Pegasus v-1.3 | Reconstruction/modifications: Sayed Eslamuddin",
...
def cyber_defence_mode():
    ...
    while True:
        show_cyber_menu()
        choice = input(GREEN + "Select cyber option (0-10): " + RESET).strip()
        cyber_options = {
